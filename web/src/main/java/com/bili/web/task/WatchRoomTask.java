...
//import com.bili.common.entity.mikufans.RecordEventData;
...
//import com.bili.web.controller.RecordWebHook;
...
//    @Resource
//    private RecordWebHook recordWebHook;
//
...
//
//        RecordEventDTO recordEventDTO = new RecordEventDTO();
//        RecordEventData recordEventData = new RecordEventData();
//        recordEventDTO.setEventData(recordEventData);
//        for (String uid : uids) {
...
//
//            recordEventData.setRoomId(roomId);
//            // 表示之前未记录过开播信息或者未开播
...
//                    recordEventDTO.setEventType("StreamStarted");
//                    recordWebHook.processingBySelf(recordEventDTO);
//                }
//                if (liveStatus == 0){
//                    // 表示当前轮询的直播间仍未开播
//                }
...
//                    recordEventDTO.setEventType("StreamEnded");
//                    recordWebHook.processingBySelf(recordEventDTO);
//                }
//            }
//
